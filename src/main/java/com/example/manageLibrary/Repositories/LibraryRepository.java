...
public interface LibraryRepository extends JpaRepository<Libraries,Long>, JpaSpecificationExecutor<Libraries> {
    ...
    List<Libraries>findAll(Specification<Libraries>spec);
}
